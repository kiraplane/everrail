...
export const websiteConfig: WebsiteConfig = {
  ...
  metadata: {
    images: {
      ogImage: '/everrail/header.jpg',
      logoLight: '/logo.svg',
      logoDark: '/logo.svg',
    },
    social: {
      github: '',
      twitter: 'https://x.com/PlayEverRail',
      blueSky: '',
      discord: 'https://discord.gg/AesirInteractive',
      mastodon: '',
      linkedin: '',
      youtube: 'https://www.youtube.com/@AesirInteractiv',
    },
  },
  features: {
  ...
  mail: {
    provider: 'resend',
    fromEmail: 'EverRail Wiki <hello@everrail.wiki>',
