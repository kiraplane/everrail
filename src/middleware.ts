...
const retiredPublicRouteRedirects: Array<{
  ...
  {
    pattern: /^\/map(?:\/.*)?$/,
    target: '/guides/expeditions-return-plan',
  },
  ...
  {
    pattern: /^\/everrail-beginner-guide(?:\/.*)?$/,
    target: '/guides/beginner-guide',
  },
  {
    pattern: /^\/everrail-map(?:\/.*)?$/,
    target: '/guides/expeditions-return-plan',
  },
  {
    pattern: /^\/everrail-download(?:\/.*)?$/,
    target: '/download',
  },
];
...
export default async function middleware(req: NextRequest) {
  ...
  const productionHosts = new Set(['everrail.wiki', 'www.everrail.wiki']);
  const canonicalHost = 'www.everrail.wiki';
