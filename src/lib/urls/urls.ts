...
export const CANONICAL_BASE_URL = 'https://www.everrail.wiki';
...
function getEverRailBaseUrl(url?: string) {
  ...
  try {
    ...
    if (
      parsedUrl.hostname === 'everrail.wiki' ||
      parsedUrl.hostname === 'www.everrail.wiki'
    ) {
...
export function getBaseUrl(): string {
  ...
  const everRailBaseUrl = getEverRailBaseUrl(configuredBaseUrl);
  if (everRailBaseUrl) {
    return everRailBaseUrl;
  }
