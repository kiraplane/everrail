  ...
  return (
    <>
      ...
      >
        ...
        >
          <Logo />
          <span className="text-lg font-semibold sm:hidden">EverRail Wiki</span>
        ...
        <div className="ml-2 flex shrink-0 items-center justify-end">
          <Button
            ...
            className="size-8 flex aspect-square h-fit cursor-pointer select-none items-center
              justify-center rounded-md border border-[#244657] text-[#eef9ff] hover:border-[#62d8ff] hover:bg-[#102b3a]"
          >
            {open ? (
...
function MainMobileMenu({ onLinkClicked }: MainMobileMenuProps) {
  ...
  return (
    <div
      ...
      border-[#244657] border-t bg-[#040b11] text-[#eef9ff] backdrop-blur-md animate-in fade-in-0"
    >
      <div className="size-full flex flex-col items-start space-y-4 pt-4">
                ...
                {item.items ? (
                    ...
                    <CollapsibleTrigger asChild>
                      <Button
                        ...
                        className={cn(
                          ...
                          'bg-transparent text-[#a8c1cf] cursor-pointer',
                          'hover:bg-transparent hover:text-[#ffbf5b]',
                          'focus:bg-transparent focus:text-[#ffbf5b]',
                          isActive &&
                            'font-semibold bg-transparent text-[#ffbf5b]'
                        )}
                      >
                            ...
                            <li key={subItem.title}>
                              ...
                              >
                                ...
                                {subItem.external && (
                                  <ArrowUpRightIcon
                                    className={cn(
                                      'size-4 shrink-0 text-[#a8c1cf] items-center',
                                      'group-hover:bg-transparent group-hover:text-[#ffbf5b]',
                                      'group-focus:bg-transparent group-focus:text-[#ffbf5b]',
                                      isSubItemActive &&
                                        'bg-transparent text-[#ffbf5b]'
                  ...
                  <LocaleLink
                    ...
                    className={cn(
                      ...
                      'hover:bg-transparent hover:text-[#ffbf5b]',
                      'focus:bg-transparent focus:text-[#ffbf5b]',
                      isActive && 'font-semibold bg-transparent text-[#ffbf5b]'
                    )}
                    onClick={onLinkClicked}
                  >
        ...
        {/* bottom buttons */}
        <div className="flex w-full items-center justify-center gap-4 border-[#244657]/70 border-t p-4">
          <LocaleSelector />
        </div>
      </div>
    </div>
