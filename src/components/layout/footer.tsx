...
export function Footer({ className }: React.HTMLAttributes<HTMLElement>) {
  ...
  return (
    <footer
      className={cn(
        'border-[#244657] border-t bg-[#040b11] text-[#eef9ff]',
        className
      )}
    >
      ...
      <div className="border-[#244657] border-t py-8">
        <Container className="px-4 flex items-center justify-between gap-x-4">
          ...
          <span className="text-muted-foreground text-sm">
            Independent guide hub. Not affiliated with Aesir Interactive, Valve,
            Steam or YouTube.
          </span>
        </Container>
      </div>
